...
return array(
    ...
    "no_permission_write"            => "Не маєте прав на запис",
    "user"                           => "користувач",
    "save_as"                        => "зберегти як",
    ...
    "system_open_true_path"          => "Успішно відкрито файловому менеджері!",
    "group_role_error"               => "Поилка дозволів групи (без настройки дозволу)",
    ...
    "system_group_remove_tips"       => "Ви впевнені в тому, що робите?<br/>Після видалення користувачів буде видалено, розділи перейдуть у корінь",
    ...
    "system_member_group"            => "Де проектна група",
    ...
    "system_member_import_desc"      => "Такий учасник ,<br/>в проектній групі вже є",
    ...
    "system_setting_root_path_desc"  => "Тільки системний адміністратор може отримати доступ до всіх каталогів, інші користувачі можуть бачити тільки свій власні каталоги користувача. Якщо ви хочете, щоб включити або вимкнути<br/>доступ адміністратора до інших каталогів, ви можете змінити PHP open_basedir параметрів анти-міжсайтових,<a href=\"https://www.google.com.hk/search?&q=php+open_basedir\" target=\"_blank\">встановити</a>",
    ...
    "role_type_name_write:add"       => "Створіть файл (папку), завантажити архів",
    ...
    "upload_exist_replace"           => "замінювати",
